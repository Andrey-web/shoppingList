		                ...
		                <tr class="status status-<?=$good->status?>">
		                    <form action="" method="post">
		                        ...
		                        <td>
		                            <input name="status" type="hidden" value="<?=$good->status?>">
		                            <div class="iconOk">
                                        <i data-formId="2" data-name="<?=$good->name?>" data-count="<?=$good->count?>" data-status="<?=$good->status?>" data-id="<?=$good->id?>" style="cursor: pointer" class="fas fa-check-circle okIcon"></i>
		                            </div>
		                        </td>
		                        <td>
		                            <div class="iconOk forHide">
		                ...
		                <tr class="status status-<?=$good->status?>">
		                    <form action="" method="post">
		                        ...
		                        <td>
		                            <input name="status" type="hidden" value="<?=$good->status?>">
		                            <div class="iconOk">
                                        <i data-formId="3" data-name="<?=$good->name?>" data-count="<?=$good->count?>" data-status="<?=$good->status?>" data-id="<?=$good->id?>" style="cursor: pointer" class="fas fa-check-circle okIcon"></i>
		                            </div>
		                        </td>
		                        <td>
		                            <div class="iconOk forHide">
